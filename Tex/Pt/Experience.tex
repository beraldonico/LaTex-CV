\section{Experiência}
	\begin{itemize}[noitemsep, left=0pt, labelsep = 0pt]
		...
		\item[\linkedlist{Experiencia profissional 2}] {
			...
			\begin{highlights}
				\item Implementei melhorias em macros do Excel e bancos de dados Access/MySQL, otimizando os tempos de processamento em 60\%.
				\item Iniciei o desenvolvimento e o uso de testes unitários em C\#, contribuindo para a qualidade do serviço.
				\item Desenvolvi scripts de automação para gerenciar alterações de código, reduzindo em 80\% o tempo gasto em tarefas simples de atualização de links.
			\end{highlights}
		}
